                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-user"></i> <span> Members </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    ...
                                    <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><span> Dues </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="update_member_dues">Update Member Dues</a></li>
                                    <li ><a href="manage-members" ><span>Dues Report</span></a></li>
                                </ul>
                            </li>
                                </ul>
                            </li>
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-users"></i> <span> Regions </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="add-region">Add Region</a></li>
                                    <li ><a href="add-region-director">Region Director</a></li>
                                    <li><a href="manage-regions" class="waves-effect"><span>Manage Regions</span></a></li>
                                    <!-- <li ><a href="boards-history">Boards History</a></li> -->
                                </ul>
                            </li>

                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-slack"></i><span>Leo Clubs </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="trashed-category">Trashed Categories</a></li>
                                </ul>
                            </li>

                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-line-weight"></i> <span>Sub Category </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi ion-speakerphone"></i> <span> Posts </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-upload"></i> <span> Upload Center </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li ><a href="upload-resources">Upload Resources</a></li>
                                </ul>
                            </li>

                           
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-lightbulb-o"></i> <span> Activity </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="ti ti-settings"></i> <span> Other Settings </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    
                                    <li class="has_sub">
                                        <a href="javascript:void(0);" class="waves-effect"><span>Membership Type</span><span class="menu-arrow"></span></a>
                                        <ul class="list-unstyled"> 
                                            <li><a href="add-member-type">Add Member Type</a></li>
                                            <li><a href="manage-member-wing">Manage Member Type</a></li>
                                        </ul>
                                    </li>
                                    <li class="has_sub">
                                        <a href="javascript:void(0);" class="waves-effect"><span>Executive Positions</span><span class="menu-arrow"></span></a>
                                        <ul class="list-unstyled"> 
                    ...
                    <!-- <div class="help-box">
                        ...
                        <p class=""><span class="text-custom">Email:</span> <br /> calabarparadiseleoclub@gmail.com</p>
                    </div> -->
