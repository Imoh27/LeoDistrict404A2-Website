...
if ($_SESSION['login'] == "" || strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['add_region'])) {
        ...
        if (!empty($result)) {
            ...
            $insert = "INSERT INTO tblregion VALUES(NULL, '$region', NOW(),' $added_by', $isActive)";
            // echo $insert; exit;
    ...
    <title>Leo District 404A2 -- Official Website | Add Region</title>
