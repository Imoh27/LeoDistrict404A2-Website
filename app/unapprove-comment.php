                                                ...
                                                <tbody>
                                                    ...
                                                    while ($row = mysqli_fetch_array($query)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a
                                                                    href="add-post.php?pid=<?php echo htmlentities($row['post']); ?>"><?php echo htmlentities($row['postTitle']); ?></a>
                                                            </td>
                                                            <td>
                                                                <?php echo htmlentities(date('d-m-Y', strtotime($row['commentDATE']))); ?>
                                                            </td>
                                                            <td>
                                                                <?php if (!$row): ?>
                                                                    <a href="unapprove-comment.php?disid=<?php echo htmlentities($row['id']); ?>"
                                                                        onclick="return confirm('Do you wish to unapprove this comment')"
                                                                ...
                                                                <?php else: ?>
                                                                    <a href="unapprove-comment.php?appid=<?php echo htmlentities($row['id']); ?>"
                                                                        onclick="return confirm('Do you wish to approve this comment?')"
