                ...
                <div class="navbar-nav me-auto">
                    <a href="index?page=home" class="nav-item nav-link <?php if ($_GET['page'] == 'home' || !$_GET['page']) {?>
                        ...
                        <div class="dropdown-menu fade-up m-0">
                            <a href="about?page=about" class="dropdown-item">About Us</a>
                            <a href="district?page=about&&section=coreofficers" class="dropdown-item">Core Officers</a>
                            <a href="district?page=about&&section=rd" class="dropdown-item">Region Directors</a>
                        </div>
                    </div>
                    <a href="gallery?page=gallery" class="nav-item nav-link <?php if ($_GET['page'] == 'gallery' || !$_GET['page']) {?>
                        active<?php } ?>">Activities</a>
                    <!-- <a href="our-activities?page=activity" class="nav-item nav-link <?php if ($_GET['page'] == 'activity' || !$_GET['page']) {?>
                        active<?php } ?>">Projects</a> -->
