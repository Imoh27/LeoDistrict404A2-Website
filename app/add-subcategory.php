...
$status=1;
$query=mysqli_query($con,"insert into tblsubcategory(CategoryId,Subcategory,SubCatDescription,UpdationDate,Is_Active) values('$categoryid','$subcatname','$subcatdescription',NOW(),'$status')");
if($query)
{
...
<html lang="en">
    <head>
        ...
        <title>CPLC -- Official Calabar Paradise Lions Club Website | Add Sub Category</title>
