...
if (strlen($_SESSION['login']) == 0) {
    ...
    if ($_GET['pdpid']) {
        ...
        if (isset($_POST['addpdp'])) {
            $fullName = htmlspecialchars($_POST['pdpName']);
            $clubs = htmlspecialchars($_POST['clubs']);
            $servicetheme = htmlspecialchars($_POST['theme']);
            $serviceYR = htmlspecialchars($_POST['lsy']);
            ...
            $update = "UPDATE tblpdp SET fullName = '$fullName', clubID  = $clubs, servicetheme = '$servicetheme', serviceYR = '$serviceYR', 
                   dateUpdated = NOW(), updatedBy  = $session";
            if ($imgfile) {
                $update .= ", pdpPhoto = '$imgnewfile' ";
            }
            $update .= " WHERE pdpID  = $pdpid";
            // echo $update; exit;
    ...
    // HANDLE CORE OFFICERS
    if ($_GET['coid']) {
        $coid = $_GET['coid'];
        if (isset($_POST['updateCoreOfficers'])) {
            $region = $_POST['region'];
            $clubs = $_POST['clubs'];
            ...
            if ($imgfile) {
                ...
                if (!in_array($extension, $allowed_extensions)) {
                    ...
                    // echo $imgnewfile; exit;
                    // Code for move image into directory
                    move_uploaded_file($_FILES["memberDp"]["tmp_name"], "coreofficersimg/" . $imgnewfile);
                }
            }
            $update = "UPDATE tblcoreofficers SET dOfficesID = $position, memberID = $member, 
                dateUpdated = NOW(), updatedBy  = $session";
                // echo $update; exit;
            if ($imgfile) {
                $update .= ", photo = '$imgnewfile' ";
            }
            $update .= " WHERE dOfficersID   = $coid";
            // echo $update; exit;
            $query = $con->query($update);
            if ($query) {
                $msg = "Successfully Updated";
...
?>
    ...
    <title>Leo District 404A2 -- Admin | District Offices</title>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                            ...
                                            <form class="form-horizontal" method="POST" name="update-activity" enctype="multipart/form-data">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group m-b-20">
                                                        ...
                                                        <select class="form-control" name="category" id="category">
                                                            <?php
                                                            if ($activityresult) {
                                                                $aCatID = $activityresult['activityCatID']; ?>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group m-b-20">
                                                        ...
                                                        <input type="text" class="form-control" id="activity_title" name="activity_title" <?php if ($activityresult) { ?> value="<?php echo htmlentities(strtoupper($activityresult['title']));
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group m-b-20">
                                                        ...
                                                        <input type="text" class="form-control" id="location" name="location" <?php if ($activityresult) { ?> value="<?php echo htmlentities(strtoupper($activityresult['activityLocation']));
                                                                                                                                                                } ?>" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group m-b-20">
                                                        ...
                                                        <input type="date" class="form-control" id="start_date" name="start_date" <?php if ($activityresult) { ?> value="<?php echo htmlentities($activityresult['startDate']);
                                                                                                                                                                    } ?>" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="card-box">
                                                            ...
                                                            <textarea class="summernote" name="activity_details" required><?php if ($activityresult) { ?> <?php echo htmlentities(substr(strip_tags($activityresult['activityDesc']), 0));
                                                                                                                                                        } ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <!-- Start Past District Presidents -->
                                <?php
                                if ($_GET['pdpid']) {
                                    $pdpID  = $_GET['pdpid'];
                                    $select = "SELECT *  From tblpdp  WHERE pdpID = $pdpID";
                                    // echo $activity; exit;
                                    $query = mysqli_query($con, $select);
                                    $pdpresult = mysqli_fetch_assoc($query);
                                ?>

                                    <div class=" col-md-12 m-t-50" id="updaate-pdp">
                                        <div class="col-md-6 col-md-offset-2">
                                            <p class="text-uppercase font-600 font-secondary text-center"><a>Update PDP</a>
                                            ...
                                            <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label">Full Name </label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" <?php if ($pdpresult) { ?> value="<?php echo htmlentities($pdpresult['fullName']);
                                                                                                                                } ?>" name="pdpName" require>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                            <?php
                                            ...
                                            <div class="col-md-8">
                                                <select class="form-control" name="region" id="region" onChange="getClubs(this.value);">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <select class="form-control" name="clubs" id="clubs" onChange="getMembers(this.value);">
                                                </select>
                                            </div>
                                        </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" Placeholder="2023/2024" name="lsy" <?php if ($pdpresult) { ?> value="<?php echo htmlentities($pdpresult['serviceYR']);
                                                                                                                                                                } ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" Placeholder="" name="theme" <?php if ($pdpresult) { ?> value="<?php echo htmlentities($pdpresult['servicetheme']);
                                                                                                                                                            } ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label">Feature Image </label>
                                                    <div class="col-md-8">
                                                        <input type="file" class="form-control" id="pdpPhoto" name="pdpPhoto">
                                                    </div>
                                                </div>
                                        ...
                                        <!-- Start Core District Officers -->
                                        <?php
                                        if ($_GET['coid']) {
                                            $coID  = $_GET['coid'];
                                            $select = "SELECT *  From tblcoreofficers  WHERE pdpID = $coID";
                                            // echo $activity; exit;
                                            $query = mysqli_query($con, $select);
                                            $pdpresult = mysqli_fetch_assoc($query);
                                        ?>
                                            ...
                                            <div class=" col-md-12 m-t-50" id="updaate-pdp">
                                                <div class="col-md-6 col-md-offset-2">
                                                    <p class="text-uppercase font-600 font-secondary text-center"><a>Update Core Officers</a></a>

                                                    </p>
                                                    <form class="form-horizontal" method="POST" name="coreOficers"
                                        ...
                                        <div class="form-group">
                                            <?php
                                                ...
                                                $query = mysqli_query($con, $select);
                                                ?>
                                            <label class="col-md-4 control-label" for="position">Select Region</label>
                                            <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-4 control-label" for="clubs">Select Club</label>
                                            <div class="col-md-8">
                                        ...
                                        <?php
                                             ...
                                             JOIN tblmembers m ON m.memberID = c.memberID INNER JOIN tblclubs cl ON cl.clubID = m.clubID
                                              JOIN tblserviceyr s ON s.serviceYrID  = c.serviceYrID ";
                                                ...
                                                <?php 
                                                 if (!empty($row)) {?>
                                                  <select class="form-control" name="members" id="members" required>
                                                    <option
                                                        value="<?php echo htmlentities($row['memberID'])?> "selected>
                                                        <?php echo htmlentities($row['firstName'] .' '. $row['lastName'])?></option>
                                                  </select>
                                                        <?php } else {?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="col-md-4 control-label" for="position">Select Position</label>
                                            <div class="col-md-8">
                                                <select class="form-control" name="positions" id="position" required style="overflow-y: scroll">
                                                <?php if (!empty($row)) {?>    
                                                <option value="<?php echo htmlentities($row['dOfficesID']); ?>" selected>
                                                        <?php echo htmlentities($row['position']); ?> </option>
                                                <?php } ?>
                                                    <?php
                                                        // Feching active categories
