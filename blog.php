        ...
        <div class="row g-0">
            <div class="col-lg-3 d-none d-lg-flex">
                <div class="d-flex align-items-center justify-content-center bg-primary w-100 h-100">
                    <h1 class="display-3 text-white m-0" style="transform: rotate(-90deg);">Monthly Newsletter</h1>
                </div>
            </div>
            <div class="col-md-12 col-lg-9">
                <div class="ms-lg-5 ps-lg-5">
                    <div class="text-center text-lg-start wow fadeInUp" data-wow-delay="0.1s">
                        <h3 class="text-secondary text-uppercase">News Letters</h3>
                    ...
                    <div class="owl-carousel service-carousel position-relative wow fadeInUp" data-wow-delay="0.1s">
                        <div class="bg-light p-4">
                            ...
                            <h4 class="mb-3">May Edition</h4>
                            <p>Stet stet justo dolor sed duo. Ut clita sea sit ipsum diam lorem diam justo. As an integral part of the Lions Clubs International network, our Leo Clubs benefit from the guidance and support of experienced Lions members. This collaboration allows us to leverage the extensive resources, expertise, and ...</p>
                        ...
                        <div class="bg-light p-4">
                            ...
                            <h4 class="mb-3">August Edition</h4>
                            <p>Stet stet justo dolor sed duo. Ut clita sea sit ipsum diam lorem diam justo. As an integral part of the Lions Clubs International network, our Leo Clubs benefit from the guidance and support of experienced Lions members. This collaboration allows us to leverage the extensive resources, expertise, and ...</p>
                            <!-- <p class="text-primary fw-medium"><i class="fa fa-check text-success me-2"></i>Quality Service</p>
                            <p class="text-primary fw-medium"><i class="fa fa-check text-success me-2"></i>Customer Satisfaction</p>
                            <p class="text-primary fw-medium"><i class="fa fa-check text-success me-2"></i>Support 24/7</p> -->
